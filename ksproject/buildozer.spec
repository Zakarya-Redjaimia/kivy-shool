...
title = LuxuryImpactParfumeRZ

# (str) Package name
package.name = MyLuxuryRz

# (str) Package domain
package.domain = org.testRz

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (extensions)
source.include_exts = py,png,jpg,kv,atlas,html,js,css,sqlite3
...
requirements = python3, kivy, https://github.com/novfensec/videonative/archive/main.zip , pyjnius
